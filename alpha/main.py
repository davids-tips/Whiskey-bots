...
Token = ('Nzk4MzMxNjgxMDI2NDc0MDA0.X_zeUQ.pGkvY-bhPjUpsokDdMrwpsE_PBI')
...
async def on_ready():
    print('Hello Master *nuzles*\n'
          ...
          'Logged in as [{0.user}]\n'.format(client))
    game = discord.Game("🐱‍💻Working With My Master🐱‍💻")
...
async def on_message(message):
    ...
    if message.content.startswith("OwO"):
        await message.channel.send("OwO Whats This?")
        if message.channel.nsfw:
            await message.channel.send("*Notices Buldge*")

    if message.content.startswith("nuz"):
        await message.channel.send("***nuzzles***")
        await message.channel.send("https://cdn.discordapp.com/attachments/798736137317253170/811095654008487946/DerpysFavs_58.jpeg")
    ...
    if message.content.startswith("dndgroup"):
      await message.channel.send("<:thomas:802907659153834024><:fred:802907477486075934><:noah:802912601947766814><:david:802914481000677376><:aidan:802929427746914324><:gage:805583021100105728>")
